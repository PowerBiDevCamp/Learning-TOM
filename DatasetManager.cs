...
namespace Learning_TOM {
  ...
  class DatasetManager {
    ...
    public static void ConnectToPowerBIAsUserInteractive() {

      string workspaceConnection = "powerbi://api.powerbi.com/v1.0/myorg/YOU_WORKSPACE";
      string connectStringUser = $"DataSource={workspaceConnection};";
    ...
    public static string GetUserConnectString() {
      string workspaceConnection = "powerbi://api.powerbi.com/v1.0/myorg/YOU_WORKSPACE";
      string userId = "YOUR_USER_NAME";
      string password = "YOUR_USER_PASSWORD";
      return $"DataSource={workspaceConnection};User ID={userId};Password={password};";
    }
    ...
    public static void DisplayRoleMembers(string DatasetName) {

      Database database = server.Databases.GetByName(DatasetName);
      ...
      foreach (ModelRole role in model.Roles) {
        foreach (ModelRoleMember member in role.Members) {
          ...
          Console.WriteLine(member.ObjectType);
